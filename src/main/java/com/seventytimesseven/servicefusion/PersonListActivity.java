...
public class PersonListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_launch_add_person_activity);
...
//                        .setAction("Action", null).show();
                ...
                PersonListActivity.this.startActivity(i);
            }
        });
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(Person.listAll(Person.class)));
    }
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putLong(PersonDetailFragment.ARG_ITEM_ID, holder.mItem.getId());
                        ...
                        intent.putExtra(PersonDetailFragment.ARG_ITEM_ID, holder.mItem.getId());
